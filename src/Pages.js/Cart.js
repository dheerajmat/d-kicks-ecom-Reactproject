        ...
        {cartItems.map((product) => (
          <li key={product.id} className="flex flex-col py-6 sm:flex-row sm:justify-between">
            <div className="flex w-full space-x-2 sm:space-x-4">
             <img
  className="h-32 w-32 sm:h-40 sm:w-40 md:h-48 md:w-48 lg:h-36 lg:w-56 xl:h-36 xl:w-64 flex-shrink-0 rounded object-contain outline-none dark:border-transparent"
